...
INSERT INTO parts (name, brand, category, compatible_cars, price_msrp, thumbnail_url, model_offset, attachment_node, description)
VALUES
  ('Volk Racing TE37SL 17"',        'Volk Racing',   'wheels', 'supra_mk4,silvia_s15,rx7_fd3s,ae86_trueno,s2000_ap1,nsx_na1', 3200.00, '/textures/parts/te37sl.png',     '{"x":0,"y":0,"z":0}', 'wheel_fl', 'RAYS forged monoblock. The benchmark.'),
  ('Enkei RPF1 17"',                'Enkei',         'wheels', 'supra_mk4,silvia_s15,evo_ix,wrx_sti_gd,s2000_ap1,ae86_trueno', 1800.00, '/textures/parts/rpf1.png',      '{"x":0,"y":0,"z":0}', 'wheel_fl', 'Lightweight competition wheel. Flow-formed 17x9.'),
  ...
  ('Volk Racing CE28N 16"',         'Volk Racing',   'wheels', 'ae86_trueno,s2000_ap1,silvia_s15',                             2800.00, '/textures/parts/ce28n.png',      '{"x":0,"y":0,"z":0}', 'wheel_fl', 'Lightweight CE-28 in classic club racer spec.'),
  ('SSR Type-C 18"',                'SSR',           'wheels', 'supra_mk4,nsx_na1,rx7_fd3s',                                   4100.00, '/textures/parts/ssr_typec.png',  '{"x":0,"y":0,"z":0}', 'wheel_fl', 'Deep dish split-rim. Show quality finish.'),
  ('Gram Lights 57DR 17"',          'Gram Lights',   'wheels', 'wrx_sti_gd,evo_ix,ae86_trueno,silvia_s15',                    1600.00, '/textures/parts/57dr.png',       '{"x":0,"y":0,"z":0}', 'wheel_fl', 'RAYS monoblock cast. Value-to-weight king.'),
  ('Advan Racing RZ-DF 18"',        'Advan Racing',  'wheels', 'supra_mk4,rx7_fd3s,evo_ix',                                    2600.00, '/textures/parts/advan_rz.png',   '{"x":0,"y":0,"z":0}', 'wheel_fl', 'Full-face Y-spoke. Advan motorsport pedigree.');
...
VALUES
  ...
  ('GReddy Revolution RS Cat-Back',  'GReddy',       'exhaust', 'supra_mk4,rx7_fd3s,silvia_s15',                   1350.00, '/textures/parts/greddy_rs.png',    '{"x":0,"y":0,"z":0}', 'exhaust_tip', 'Dual-exit twin tip. Polished stainless.'),
...
INSERT INTO parts (name, brand, category, compatible_cars, price_msrp, thumbnail_url, model_offset, attachment_node, description)
VALUES
  ('HKS Racing Suction Cold Air Intake', 'HKS',           'engine_bay', 'supra_mk4,silvia_s15,evo_ix,wrx_sti_gd', 380.00,  '/textures/parts/hks_intake.png',     '{}', 'hood', 'Short ram pod filter. +15hp sound and look.'),
  ...
  ('Nismo Titanium Cam Cover',           'Nismo',         'engine_bay', 'silvia_s15',                              580.00,  '/textures/parts/nismo_camcover.png', '{}', 'hood', 'SR20DET titanium-finish cam cover. Signature Nismo blue bolts.');
